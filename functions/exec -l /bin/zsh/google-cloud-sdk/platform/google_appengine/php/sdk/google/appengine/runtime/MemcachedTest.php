...
class MemcachedTest extends ApiProxyTestBase {
  ...
  public function testPeekSuccess() {
    ...
    $this->assertEquals($res->getLastAccessTimeSec(), $mits->getLastAccessTimeSec());
    $this->assertEquals($res->getExpirationTimeSec(), $mits->getExpirationTimeSec());
    $this->assertEquals($res->getDeleteLockTimeSec(), $mits->getDeleteLockTimeSec());
    $this->assertEquals($memcached->getResultCode(), Memcached::RES_SUCCESS);
    $this->apiProxyMock->verify();
  }
  ...
  public function testPeekMultiSuccess() {
    ...
    $this->assertEquals($want->getLastAccessTimeSec(), $result["key"]->getLastAccessTimeSec());
    $this->assertEquals($want->getExpirationTimeSec(), $result["key"]->getExpirationTimeSec());
    $this->assertEquals($want->getDeleteLockTimeSec(), $result["key"]->getDeleteLockTimeSec());
    $this->assertEquals(123456, $cas_tokens["key"]);
    $this->assertTrue(array_key_exists("key1", $result));
    $this->assertNull($result["key1"]);
    $this->assertTrue(array_key_exists("key1", $cas_tokens));
